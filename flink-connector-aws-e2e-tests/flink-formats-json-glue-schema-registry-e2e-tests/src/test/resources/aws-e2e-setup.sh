...
#
# Setup and teardown AWS resources for json-glue E2E tests.
#
# Usage:
...
#   KINESIS_STREAM      - Kinesis stream name (default: flink-json-glue-e2e-test)
#   GSR_REGISTRY_NAME   - GSR registry name (default: flink-json-glue-e2e-registry)

set -euo pipefail

AWS_REGION="${AWS_REGION:-us-east-1}"
KINESIS_STREAM="${KINESIS_STREAM:-flink-json-glue-e2e-test}"
GSR_REGISTRY_NAME="${GSR_REGISTRY_NAME:-flink-json-glue-e2e-registry}"
